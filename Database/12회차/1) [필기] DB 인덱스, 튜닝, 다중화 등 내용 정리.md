...
INSERT : 인덱스 노드 블록이 쪼개진다. 삽입 중 데이터 변경 이뤄지지 않도록 DML 블록하게 된다.

DELETE : 인덱스 데이터를 사용 불가 형태로 변경(삭제X) 데이터를 차지한다.
...
- 모든 노드들에 대해 값을 저장하고 있으며 포인터 역할 동반한다.
    ...
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/e2aaace0-24ef-4ae8-bed4-d8cb2e34acd9/a211d995-98b9-4ea3-ab24-9b38cee61c92/Untitled.png)
...
<aside>
💡 "왜 하필 B-Tree지?""탐색 시간이 O(logN)인 자료구조나 알고리즘은 다른 것들도 많지 않나?" "해시 테이블은 O(1)인데, 그러면 차라리 해시 테이블을 쓰는 게 더 빠르지 않나?""그러면 밸런스 트리 중 B-Tree 말고도 RedBlack-Tree로도 사용할 수 있는 것 아닌가?"
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/e2aaace0-24ef-4ae8-bed4-d8cb2e34acd9/40888e90-c371-40cf-a5a4-aaa1a409d220/Untitled.png)

### 2. 리플리케이션 (Replication)

- **DB 서버와 저장소를 같이 다중화하는 것**
- 비동기화 방식
- 자동 FailOver 기능 X

![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/e2aaace0-24ef-4ae8-bed4-d8cb2e34acd9/84e0c289-1ded-4567-8af7-f84a6eafb9e8/Untitled.png)
